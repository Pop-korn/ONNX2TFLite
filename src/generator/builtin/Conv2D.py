...
class Conv2D(meta.BuiltinOptions):
    ...
    , strideH: int = 0, dilationWFactor: int = 1, dilationHFacrot: int = 1
    , fusedActivationFunction: aft.ActivationFunctionType = aft.ActivationFunctionType.NONE) -> None:
        ...
        self.dilationHFacrot = dilationHFacrot
    ...
    def genTFLite(self, builder: fb.Builder):
        ...
        conv.AddDilationHFactor(builder,self.dilationHFacrot)
